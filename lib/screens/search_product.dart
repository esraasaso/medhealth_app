...
class SearchProdcut extends StatefulWidget {
  @override
  _SearchProdcutState createState() => _SearchProdcutState();
}

class _SearchProdcutState extends State<SearchProdcut> {
          ...
          searchController.text.isEmpty || listSearchProduct.length == 0
              ? Padding(
                  ...
                  child: Ilustration(
                      ...
                      "There is no medicine that is looking for",
                      "Please find the product you want,",
                      "the product will appear here",
                      "",
                      Container()),
                )
              : Container(
