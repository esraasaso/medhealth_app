class Personal {
  ...
  static String updateQuantityProductCart ="http://$ipAddress/medhealth_db/update_quantity.php";
  static String totalPriceCart = "http://$ipAddress/medhealth_db/get_total_price.php?userID=";
  ...
  static String historyOrder = "http://$ipAddress/medhealth_db/get_history.php?id_user=";
}
